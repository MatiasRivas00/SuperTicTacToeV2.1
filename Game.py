...
class Game:
    ...
    def play1(self,  pos):
        ...
        center = Coordinates.center(self.screen.get_width(), self.screen.get_height())
        x, y = Coordinates.new_cord(pos[0], pos[1], center)
        self.board.put(mark, x, y)
        tx, ty = Coordinates.fig_center(x, y, center)
